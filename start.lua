...
print("::JimmY::")
local RunBot = io.open("JimmY", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/JimmY
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr JimmY.lua
wget "https://raw.githubusercontent.com/SourceJimmY/JimmY/master/JimmY.lua"
while(true) do
rm -fr ../.telegram-cli
./tg -s ./JimmY.lua -p PROFILE --bot=$token
done
]])
RunBot:close()
...
while(true) do
rm -fr ../.telegram-cli
screen -S JimmY -X kill
screen -S JimmY ./JimmY
done
]])
RunTs:close()
end
