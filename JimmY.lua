...
serpent = dofile("serpent.lua")JSON = dofile("dkjson.lua")
...
if hash or DevBot(msg) or DevJimmY(msg) or VIP_DeV(msg) then    
return true 
else 
return false 
end 
...
if hash or Bot(msg) or DevJimmY(msg) or DevBot(msg) or VIP_DeV(msg) or creatorA(msg) then     
return true 
else 
return false 
end 
...
if hash or Bot(msg) or DevJimmY(msg) or DevBot(msg) or BasicConstructor(msg) or VIP_DeV(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or DevJimmY(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or VIP_DeV(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or DevJimmY(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or VIP_DeV(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or  DevJimmY(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or VIP_DeV(msg) or creatorA(msg) then             
return true 
else 
return false 
end 
...
var = true  
elseif tonumber(user_id) == tonumber(1837288438) then
var = true  
...
local NameUser = "[- JimmY𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/SourceJimmY)\n𓏍𓏍𓏍𓏍𓏍𓏍𓏍𓏍 —\n⊀︙بواسطه -› ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "[- JimmY𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/SourceJimmY)\n𓏍𓏍𓏍𓏍𓏍𓏍𓏍𓏍 —\n⊀︙اسم المستخدم -› ["..data.first_name_.."](T.me/"..UserName..")"
if status == "lock" then
...
send(msg.chat_id_, msg.id_,"[- JimmY𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/SourceJimmY)\n𓏍𓏍𓏍𓏍𓏍𓏍𓏍𓏍 —\n⊀︙العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "SourceJimmY")..")".."\n⊀︙تم رفعه "..RTPA.." هنا\n")
...
local gmedia = database:scard(bot_id.."JimmY:allM"..msg.chat_id_)  
if gmedia == 200 then
local liste = database:smembers(bot_id.."JimmY:allM"..msg.chat_id_)
...
local gmria = database:scard(bot_id.."JimmY:allM"..msg.chat_id_)  
...
database:set(bot_id.."JimmY:Set:Cmd:Group:New1"..msg.chat_id_..":ا","ايدي")
database:sadd(bot_id.."JimmY:List:Cmd:Group:New"..msg.chat_id_,"ا")
database:set(bot_id.."JimmY:Set:Cmd:Group:New1"..msg.chat_id_..":م","رفع مميز")
database:sadd(bot_id.."JimmY:List:Cmd:Group:New"..msg.chat_id_,"م")
database:set(bot_id.."JimmY:Set:Cmd:Group:New1"..msg.chat_id_..":اد","رفع ادمن")
database:sadd(bot_id.."JimmY:List:Cmd:Group:New"..msg.chat_id_,"اد")
database:set(bot_id.."JimmY:Set:Cmd:Group:New1"..msg.chat_id_..":مد","رفع مدير")
database:sadd(bot_id.."JimmY:List:Cmd:Group:New"..msg.chat_id_,"مد")
database:set(bot_id.."JimmY:Set:Cmd:Group:New1"..msg.chat_id_..":من","رفع منشئ")
database:sadd(bot_id.."JimmY:List:Cmd:Group:New"..msg.chat_id_,"من")
database:set(bot_id.."JimmY:Set:Cmd:Group:New1"..msg.chat_id_..":اس","رفع منشئ اساسي")
database:sadd(bot_id.."JimmY:List:Cmd:Group:New"..msg.chat_id_,"اس")
database:set(bot_id.."JimmY:Set:Cmd:Group:New1"..msg.chat_id_..":تعط","تعطيل الايدي بالصوره")
database:sadd(bot_id.."JimmY:List:Cmd:Group:New"..msg.chat_id_,"تعط")
database:set(bot_id.."JimmY:Set:Cmd:Group:New1"..msg.chat_id_..":تفع","تفعيل الايدي بالصوره")
database:sadd(bot_id.."JimmY:List:Cmd:Group:New"..msg.chat_id_,"تفع")
...
database:del(bot_id.."JimmY:Sudo:Rd"..msg.chat_id_)
database:del(bot_id.."JimmY:BasicConstructor:Rd"..msg.chat_id_)
database:del(bot_id.."JimmY:Constructor:Rd"..msg.chat_id_)
database:del(bot_id.."JimmY:Manager:Rd"..msg.chat_id_) 
database:del(bot_id.."JimmY:Mod:Rd"..msg.chat_id_)
database:del(bot_id.."JimmY:Special:Rd"..msg.chat_id_)
database:del(bot_id.."JimmY:Memp:Rd"..msg.chat_id_)
end
if text == ("مسح ردود المدير") and BasicConstructor(msg) then
local list = database:smembers(bot_id.."JimmY:List:Manager"..msg.chat_id_.."")
for k,v in pairs(list) do
database:del(bot_id.."JimmY:Add:Rd:Manager:AudioCa"..v..msg.chat_id_)
database:del(bot_id.."JimmY:Add:Rd:Manager:FileCa"..v..msg.chat_id_)
database:del(bot_id.."JimmY:Add:Rd:Manager:VideoCa"..v..msg.chat_id_)
database:del(bot_id.."JimmY:Add:Rd:Manager:PhotoCa"..v..msg.chat_id_)
database:del(bot_id.."JimmY:Add:Rd:Manager:VicoCa"..v..msg.chat_id_)
database:del(bot_id.."JimmY:Add:Rd:Manager:GifCa"..v..msg.chat_id_)
...
database:set(bot_id.."JimmY:Add:Rd:Manager:VicoCa"..test..msg.chat_id_, rtr)  
end
end     
...
rtr = msg.content_.caption_
rtr = rtr:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","") 
database:set(bot_id.."JimmY:Add:Rd:Manager:GifCa"..test..msg.chat_id_, rtr)  
end
end  
if text then   
text = text:gsub('"',"") 
...
rtr = msg.content_.caption_
rtr = rtr:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","") 
database:set(bot_id.."JimmY:Add:Rd:Manager:AudioCa"..test..msg.chat_id_, rtr)  
end
end  
...
rtr = msg.content_.caption_
rtr = rtr:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","") 
database:set(bot_id.."JimmY:Add:Rd:Manager:FileCa"..test..msg.chat_id_, rtr)  
end
end  
...
rtr = msg.content_.caption_
rtr = rtr:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","") 
database:set(bot_id.."JimmY:Add:Rd:Manager:VideoCa"..test..msg.chat_id_, rtr)  
end
end  
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
rtr = msg.content_.caption_
rtr = rtr:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","") 
database:set(bot_id.."JimmY:Add:Rd:Manager:PhotoCa"..test..msg.chat_id_, rtr)  
end
end  
...
database:del(bot_id.."JimmY:Add:Rd:Manager:AudioCa"..text..msg.chat_id_)
database:del(bot_id.."JimmY:Add:Rd:Manager:VicoCa"..text..msg.chat_id_)
database:del(bot_id.."JimmY:Add:Rd:Manager:PhotoCa"..text..msg.chat_id_)
database:del(bot_id.."JimmY:Add:Rd:Manager:FileCa"..text..msg.chat_id_)
database:del(bot_id.."JimmY:Add:Rd:Manager:GifCa"..text..msg.chat_id_)
database:del(bot_id.."JimmY:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."JimmY:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."JimmY:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."JimmY:Add:Rd:Manager:Text"..text..msg.chat_id_)   
...
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'JimmY:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local veicoCa = database:get(bot_id.."JimmY:Add:Rd:Manager:VicoCa"..text..msg.chat_id_)  or ""
...
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'JimmY:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local videoCa = database:get(bot_id.."JimmY:Add:Rd:Manager:VideoCa"..text..msg.chat_id_) or ""
...
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'JimmY:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local anemiCa = database:get(bot_id.."JimmY:Add:Rd:Manager:GifCa"..text..msg.chat_id_) or ""
...
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'JimmY:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local documentCa = database:get(bot_id.."JimmY:Add:Rd:Manager:FileCa"..text..msg.chat_id_) or ""
...
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'JimmY:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local audioCa = database:get(bot_id.."JimmY:Add:Rd:Manager:AudioCa"..text..msg.chat_id_)  or ""
...
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'JimmY:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local photoCa = database:get(bot_id.."JimmY:Add:Rd:Manager:PhotoCa"..text..msg.chat_id_) or ""
...
function Function_JimmY(extra, result, success)
if DevJimmYe(result.sender_user_id_)  then
...
if DevJimmYe(msg.sender_user_id_)  then
database:srem(bot_id.."DEV:Sudo:T",result.sender_user_id_)
database:srem(bot_id.."JimmY:Sudo:User", result.sender_user_id_)
database:srem(bot_id.."JimmY:Basic:Constructor"..msg.chat_id_,result.sender_user_id_)
database:srem(bot_id.."JimmY:Constructor"..msg.chat_id_, result.sender_user_id_)
...
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^تنزيل الكل @(.*)$")}, Function_JimmY, nil)
end
...
if text == (database:get(bot_id.."JimmY:Name:Bot") or "جيمي") then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Namebot = (database:get(bot_id.."JimmY:Name:Bot") or "جيمي")
local namebot = {
...
zh = https.request('https://JimmY-source.tk/JimmYTeAM/frills.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n⊀️︙قائمه الزخرفه \n𓏍𓏍𓏍𓏍𓏍𓏍𓏍𓏍𓏍\n"
i = 0
...
gk = https.request('https://JimmY-source.tk/JimmYTeAM/Horoscopes.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
...
ge = https.request('https://JimmY-source.tk/JimmYTeAM/Calculateage.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
...
data,res = https.request('https://JimmY-source.tk/JimmYTeAM/infoInstagram.php?username='..URL.escape(Textni)..'')
if res == 200 then
...
data,res = https.request('https://JimmY-source.tk/JimmYTeAM/movie.php?serch='..URL.escape(Textm)..'')
if res == 200 then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- JimmYTeAM .',url="t.me/SourceJimmY"}},
}
local msg_id = msg.id_/2097152/0.5
...
if DevJimmY(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SourceJimmY/files_JimmY/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n⊀︙اهلا بك في متجر ملفات جيمي\n⊀︙يوجد في المتجر ملف الردود\n⊀︙يتم ادراج الملفات في التحديثات القادمه \n𓏍𓏍𓏍𓏍𓏍𓏍𓏍𓏍𓏍\n"
...
[⊀︙ JimmY𝖲𝗈𝗎𝗋𝖼𝖾  .](http://t.me/SourceJimmY)
     
[⊀︙ JimmYDeveloper .](http://t.me/HMMDD)
]]
send(msg.chat_id_, msg.id_,Text)
end
...
if database:get(bot_id.."JimmYBTSS:Set:Name:Bot"..msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ⊀" then   
send(msg.chat_id_, msg.id_,"⊀︙ تم الغاء حفظ اسم البوت") 
database:del(bot_id.."JimmYBTSS:Set:Name:Bot"..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."JimmYBTSS:Set:Name:Bot"..msg.sender_user_id_) 
database:set(bot_id.."JimmY:Name:Bot",text) 
...
database:setex(bot_id.."JimmYBTSS:Set:Name:Bot"..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_,"⊀︙ ارسل لي الاسم الان ")  
end
...
inline = {
{{text = '⊀︙ JimmY𝖲𝗈𝗎𝗋𝖼𝖾  .',url='http://t.me/SourceJimmY'}},
}
...
inline = {
{{text = '⊀︙ JimmY𝖲𝗈𝗎𝗋𝖼??  .',url='http://t.me/SourceJimmY'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
...
local Name_Bot = (database:get(bot_id.."JimmY:Name:Bot") or "جيمي")
